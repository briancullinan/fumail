    ...
    */
    ajax: {
      ...
      _ajax: function(request) {
        ...
        if (_xhr) {
          Pollen.ajax._confXHR(_xhr, options, json, ajaxSuccess, ajaxProgress);
      ...
      _confXHR: function(_cxhr, options, json, ajaxSuccess, ajaxProgress) {

        var data, _xjson, evt;

          var onprogress = _cxhr.onprogress = function (evt)
          {
            evt = evt;
              progress();
          }
        ...
        var onreadystatechange = _cxhr.onreadystatechange = function() {
          ...
          if (_cxhr.readyState == 4) {
              ...
              if(_cxhr.getResponseHeader('content-type').indexOf('json') > -1)
              {
                  try
                  {
                      _xjson = JSON.parse(_cxhr.responseText)
                  }
                  catch(e)
                  {
                      _xjson = null;
